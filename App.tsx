                 ...
                 <ul className="space-y-4 text-sm text-slate-400">
                    ...
                    <li className="flex items-center gap-3 pt-2">
                       ...
                       <a 
                         ...
                         className="group relative w-12 h-12 rounded-full bg-slate-900 border border-[#25D366]/50 flex items-center justify-center text-[#25D366] hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all duration-300 hover:shadow-[0_0_20px_rgba(37,211,102,0.4)] active:scale-95"
                       ...
                       <a 
                         ...
                         target="_blank" 
                         rel="noopener noreferrer"
                         className="group relative w-12 h-12 rounded-full bg-slate-900 border border-[#0088cc]/50 flex items-center justify-center text-[#0088cc] hover:bg-[#0088cc] hover:text-white hover:border-[#0088cc] transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,136,204,0.4)] active:scale-95"
                       ...
                       >
                         ...
                         <Send size={24} className="relative z-10 ml-[-2px]" />
                       </a>
                    </li>
                 </ul>
              </div>
