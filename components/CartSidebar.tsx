...
export const CartSidebar: React.FC<CartSidebarProps> = ({
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-full sm:w-[420px] bg-dark border-l border-white/5 z-50 shadow-2xl transform transition-transform duration-300 flex flex-col ${
