                 ...
                 <ul className="space-y-4 text-sm text-slate-400">
                    ...
                    <li className="flex items-center gap-3 pt-2">
                       ...
                       <a 
                         ...
                         className="w-10 h-10 rounded-full bg-[#25D366]/20 flex items-center justify-center text-[#25D366] border border-[#25D366]/30 hover:bg-[#25D366] hover:text-white transition-all duration-300"
